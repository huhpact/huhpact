...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app_foundation_sfra/cartridge/client/default/js/main.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app_foundation_sfra/cartridge/client/default/js/components/animation.js":
/*!*********************************************************************************!*\
  !*** ./app_foundation_sfra/cartridge/client/default/js/components/animation.js ***!
  \*********************************************************************************/
...
function gsapAnimationInitialization() {
  $('.js-cart-account-benefits-animate').each(function () {
    ...
    setInterval(function () {
      var cartBenefitsAnimate = gsap.timeline({
        //eslint-disable-line
        onComplete: function () {
      ...
      cartBenefitsAnimate.fromTo(messages[currentMessage], {
        opacity: 1,
        duration: 0.3,
        ease: 'power2.out'
      }, {
        opacity: 0
      }).fromTo(messages[nextMessage], {
        x: 30,
        opacity: 0,
        duration: 0.3,
        delay: 0.3,
  ...
  $('.js-animate-account-benefits-icons').each(function () {
    ...
    setInterval(function () {
      var iconBenefitsAnimate = gsap.timeline({
        //eslint-disable-line
        onComplete: function () {
      ...
      iconBenefitsAnimate.fromTo(icons[currentIcon], {
        opacity: 1,
        duration: 0.3,
        delay: 2.7,
        ease: 'power2.out'
...
/***/ "./app_foundation_sfra/cartridge/client/default/js/components/clientSideValidation.js":
/*!********************************************************************************************!*\
  !*** ./app_foundation_sfra/cartridge/client/default/js/components/clientSideValidation.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
var base = __webpack_require__(/*! base/components/clientSideValidation */ "./app_storefront_base/cartridge/client/default/js/components/clientSideValidation.js");
...
function validateShippingForm(id) {
  ...
  if (valid) {
    ...
    var hasAddressError = $('#dwfrm_shipping').hasClass('form-has-suburb') ? $(id).closest('.shipping-content').find('div.shipping-address-error').hasClass('alert alert-danger') : false;
...
function specialCharactersValidation(currentObj) {
  ...
  if (pattern && currentValue && validationMessage && (currentObj.hasClass('shippingFirstName') || currentObj.hasClass('billingFirstName') || currentObj.hasClass('shippingLastName') || currentObj.hasClass('billingLastName') || currentObj.hasClass('shippingAddressOne') || currentObj.hasClass('billingAddressOne') || currentObj.hasClass('shippingAddressTwo') || currentObj.hasClass('billingAddressTwo'))) {
...
module.exports = {
  ...
  focusoutValidation: function () {
    $('body').on('blur', 'input, select', function (e) {
      ...
      if (currentObj.attr('id') === 'registration-form-email' || currentObj.hasClass('js-login-email') || currentObj.hasClass('js-shipping-email') || currentObj.hasClass('js-billing-email')) {
        ...
        if (value && isValid) {
          currentObj.addClass('has-success').removeClass('is-invalid invalid-custom-email');
          currentObj.closest('.form-group').find('.invalid-feedback').html('');
        } else if (value === null || value === '') {
          currentObj.removeClass('has-success').addClass('is-invalid invalid-custom-email');
          ...
          currentObj.parents('.form-group').find('.invalid-feedback').show();
          currentObj.parents('form').find('.login-message, .register-message').addClass('hide');
        }
  ...
  validateCreditCardNumber: function () {
    $('body').on('blur', '.cyb-credit-card-form #cardNumber', function () {
      ...
      if (isValid) {
        ...
        if (isCCValid) {
          $(this).addClass('has-success').removeClass('is-invalid');
          var cardType = getCreditCardType(cardNumber.replace(/\s+/g, ''));
  ...
  validateCVV: function () {
    $('body').on('input change', '.cyb-credit-card-form #securityCode,.cyb-credit-card-form #saved-payment-security-code', function () {
    ...
    $('body').on('blur change', '.js-reg-form-pwd-confirm', function () {
      ...
      if ($(this).val()) {
        if (password != confirmPassword) {
          $(this).addClass('is-invalid');
          $(this).removeClass('has-success');
          $(this).parents('.form-group').find('.invalid-feedback').text($(this).data('passmatch-error'));
        } else {
          $(this).removeClass('is-invalid');
          $(this).addClass('has-success');
          $(this).closest('div.form-group').find('.invalid-feedback').text('');
    ...
    $('body').on('blur change', '.js-reg-form-email-confirm', function () {
      ...
      if ($(this).val()) {
        if (emailConfirm != '' && email.toLowerCase() != emailConfirm.toLowerCase()) {
          ...
          $(this).parents('.form-group').find('.invalid-feedback').text($(this).data('emailnomatch-error'));
        } else {
...
/***/ "./app_foundation_sfra/cartridge/client/default/js/components/formFields.js":
/*!**********************************************************************************!*\
  !*** ./app_foundation_sfra/cartridge/client/default/js/components/formFields.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./app_foundation_sfra/cartridge/client/default/js/components/miniCart.js":
/*!********************************************************************************!*\
  !*** ./app_foundation_sfra/cartridge/client/default/js/components/miniCart.js ***!
  \********************************************************************************/
/*! no static exports found */
...
module.exports = function () {
  ...
  $('body').on('cart:update', function () {
    var cartTotal = $('.grand-total').text();

    if (cartTotal != '' && Number(cartTotal.replace(/[^\d]/g, '')) > 0) {
      $('.payment-checkout').removeClass('d-none');
    } else {
      $('.payment-checkout').addClass('d-none');
    }
...
/***/ "./app_foundation_sfra/cartridge/client/default/js/main.js":
/*!*****************************************************************!*\
  !*** ./app_foundation_sfra/cartridge/client/default/js/main.js ***!
  \*****************************************************************/
/*! no static exports found */
...
$(document).ready(function () {
  processInclude(__webpack_require__(/*! base/components/menu */ "./app_storefront_base/cartridge/client/default/js/components/menu.js"));
  processInclude(__webpack_require__(/*! base/components/cookie */ "./app_storefront_base/cartridge/client/default/js/components/cookie.js"));
  processInclude(__webpack_require__(/*! base/components/consentTracking */ "./app_storefront_base/cartridge/client/default/js/components/consentTracking.js"));
  processInclude(__webpack_require__(/*! base/components/footer */ "./app_storefront_base/cartridge/client/default/js/components/footer.js"));
  processInclude(__webpack_require__(/*! ./components/miniCart */ "./app_foundation_sfra/cartridge/client/default/js/components/miniCart.js"));
  processInclude(__webpack_require__(/*! base/components/collapsibleItem */ "./app_storefront_base/cartridge/client/default/js/components/collapsibleItem.js"));
  processInclude(__webpack_require__(/*! base/components/search */ "./app_storefront_base/cartridge/client/default/js/components/search.js"));
  processInclude(__webpack_require__(/*! base/components/toolTip */ "./app_storefront_base/cartridge/client/default/js/components/toolTip.js"));
  processInclude(__webpack_require__(/*! ./components/formFields */ "./app_foundation_sfra/cartridge/client/default/js/components/formFields.js"));
  processInclude(__webpack_require__(/*! ./components/clientSideValidation */ "./app_foundation_sfra/cartridge/client/default/js/components/clientSideValidation.js"));
  processInclude(__webpack_require__(/*! ./components/swiperInit */ "./app_foundation_sfra/cartridge/client/default/js/components/swiperInit.js"));
  processInclude(__webpack_require__(/*! ./components/animation */ "./app_foundation_sfra/cartridge/client/default/js/components/animation.js"));
});

__webpack_require__(/*! base/thirdParty/bootstrap */ "./app_storefront_base/cartridge/client/default/js/thirdParty/bootstrap.js");

__webpack_require__(/*! base/components/spinner */ "./app_storefront_base/cartridge/client/default/js/components/spinner.js");

__webpack_require__(/*! simplebar */ "./node_modules/simplebar/dist/simplebar.esm.js");

/***/ }),

/***/ "./app_storefront_base/cartridge/client/default/js/components/clientSideValidation.js":
/*!********************************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/clientSideValidation.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/collapsibleItem.js":
/*!***************************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/collapsibleItem.js ***!
  \***************************************************************************************/
/*! no static exports found */
...
var focusHelper = __webpack_require__(/*! ../components/focus */ "./app_storefront_base/cartridge/client/default/js/components/focus.js");
/**
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/cookie.js":
/*!******************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/cookie.js ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/focus.js":
/*!*****************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/focus.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/footer.js":
/*!******************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/footer.js ***!
  \******************************************************************************/
/*! no static exports found */
...
var scrollAnimate = __webpack_require__(/*! ./scrollAnimate */ "./app_storefront_base/cartridge/client/default/js/components/scrollAnimate.js");
/**
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/keyboardAccessibility.js":
/*!*********************************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/keyboardAccessibility.js ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/menu.js":
/*!****************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/menu.js ***!
  \****************************************************************************/
/*! no static exports found */
...
var keyboardAccessibility = __webpack_require__(/*! ./keyboardAccessibility */ "./app_storefront_base/cartridge/client/default/js/components/keyboardAccessibility.js");
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/search.js":
/*!******************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/search.js ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/spinner.js":
/*!*******************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/spinner.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/components/toolTip.js":
/*!*******************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/components/toolTip.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./app_storefront_base/cartridge/client/default/js/thirdParty/bootstrap.js":
/*!*********************************************************************************!*\
  !*** ./app_storefront_base/cartridge/client/default/js/thirdParty/bootstrap.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
class Alert {
  ...
  _getRootElement(element) {
    ...
    if (!parent) {
      parent = (0, _jquery.default)(element).closest(`.${ClassName.ALERT}`)[0];
    }
  ...
  _triggerCloseEvent(element) {
    const closeEvent = _jquery.default.Event(Event.CLOSE);
  ...
  _removeElement(element) {
    ...
    const transitionDuration = _util.default.getTransitionDurationFromElement(element);

    (0, _jquery.default)(element).one(_util.default.TRANSITION_END, event => this._destroyElement(element, event)).emulateTransitionEnd(transitionDuration);
  }
...
class Carousel {
  ...
  to(index) {
    ...
    if (this._isSliding) {
      (0, _jquery.default)(this._element).one(Event.SLID, () => this.to(index));
      return;
    }
  ...
  _addEventListeners() {
    if (this._config.keyboard) {
      (0, _jquery.default)(this._element).on(Event.KEYDOWN, event => this._keydown(event));
    }

    if (this._config.pause === 'hover') {
      (0, _jquery.default)(this._element).on(Event.MOUSEENTER, event => this.pause(event)).on(Event.MOUSELEAVE, event => this.cycle(event));
    }
  ...
  _addTouchEventListeners() {
    ...
    (0, _jquery.default)(this._element.querySelectorAll(Selector.ITEM_IMG)).on(Event.DRAG_START, e => e.preventDefault());

    if (this._pointerEvent) {
      (0, _jquery.default)(this._element).on(Event.POINTERDOWN, event => start(event));
      (0, _jquery.default)(this._element).on(Event.POINTERUP, event => end(event));

      this._element.classList.add(ClassName.POINTER_EVENT);
    } else {
      (0, _jquery.default)(this._element).on(Event.TOUCHSTART, event => start(event));
      (0, _jquery.default)(this._element).on(Event.TOUCHMOVE, event => move(event));
      (0, _jquery.default)(this._element).on(Event.TOUCHEND, event => end(event));
    }
  }
  ...
  _triggerSlideEvent(relatedTarget, eventDirectionName) {
    ...
    const slideEvent = _jquery.default.Event(Event.SLIDE, {
      relatedTarget,
  ...
  _setActiveIndicatorElement(element) {
    if (this._indicatorsElement) {
      ...
      (0, _jquery.default)(indicators).removeClass(ClassName.ACTIVE);

      const nextIndicator = this._indicatorsElement.children[this._getItemIndex(element)];

      if (nextIndicator) {
        (0, _jquery.default)(nextIndicator).addClass(ClassName.ACTIVE);
      }
    }
  }
  ...
  _slide(direction, element) {
    ...
    if (nextElement && (0, _jquery.default)(nextElement).hasClass(ClassName.ACTIVE)) {
      this._isSliding = false;
      return;
    }
    ...
    const slidEvent = _jquery.default.Event(Event.SLID, {
    ...
    if ((0, _jquery.default)(this._element).hasClass(ClassName.SLIDE)) {
      ...
      const transitionDuration = _util.default.getTransitionDurationFromElement(activeElement);

      (0, _jquery.default)(activeElement).one(_util.default.TRANSITION_END, () => {
        (0, _jquery.default)(nextElement).removeClass(`${directionalClassName} ${orderClassName}`).addClass(ClassName.ACTIVE);
        (0, _jquery.default)(activeElement).removeClass(`${ClassName.ACTIVE} ${orderClassName} ${directionalClassName}`);
        this._isSliding = false;
        setTimeout(() => (0, _jquery.default)(this._element).trigger(slidEvent), 0);
      }).emulateTransitionEnd(transitionDuration);
    } else {
      (0, _jquery.default)(activeElement).removeClass(ClassName.ACTIVE);
      (0, _jquery.default)(nextElement).addClass(ClassName.ACTIVE);
      this._isSliding = false;
  ...
  static _jQueryInterface(config) {
    return this.each(function () {
      ...
      let _config = _objectSpread(_objectSpread({}, Default), (0, _jquery.default)(this).data());
  ...
  static _dataApiClickHandler(event) {
    ...
    if (!target || !(0, _jquery.default)(target).hasClass(ClassName.CAROUSEL)) {
      return;
    }

    const config = _objectSpread(_objectSpread({}, (0, _jquery.default)(target).data()), (0, _jquery.default)(this).data());
...
(0, _jquery.default)(document).on(Event.CLICK_DATA_API, Selector.DATA_SLIDE, Carousel._dataApiClickHandler);
(0, _jquery.default)(window).on(Event.LOAD_DATA_API, () => {
...
class Collapse {
  ...
  show() {
    ...
    const startEvent = _jquery.default.Event(Event.SHOW);
    ...
    const complete = () => {
      (0, _jquery.default)(this._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).addClass(ClassName.SHOW);
      this._element.style[dimension] = '';
      this.setTransitioning(false);
      (0, _jquery.default)(this._element).trigger(Event.SHOWN);
    };
  ...
  hide() {
    ...
    const startEvent = _jquery.default.Event(Event.HIDE);
    ...
    const complete = () => {
      this.setTransitioning(false);
      (0, _jquery.default)(this._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).trigger(Event.HIDDEN);
    };
  ...
  _getDimension() {
    const hasWidth = (0, _jquery.default)(this._element).hasClass(Dimension.WIDTH);
  ...
  _addAriaAndCollapsedClass(element, triggerArray) {
    const isOpen = (0, _jquery.default)(element).hasClass(ClassName.SHOW);
  ...
  static _jQueryInterface(config) {
    return this.each(function () {
      ...
      const _config = _objectSpread(_objectSpread(_objectSpread({}, Default), $this.data()), typeof config === 'object' && config ? config : {});
...
class Modal {
  ...
  show(relatedTarget) {
    ...
    const showEvent = _jquery.default.Event(Event.SHOW, {
      relatedTarget
    });
    ...
    (0, _jquery.default)(this._element).on(Event.CLICK_DISMISS, Selector.DATA_DISMISS, event => this.hide(event));
    (0, _jquery.default)(this._dialog).on(Event.MOUSEDOWN_DISMISS, () => {
      (0, _jquery.default)(this._element).one(Event.MOUSEUP_DISMISS, event => {
        if ((0, _jquery.default)(event.target).is(this._element)) {
  ...
  hide(event) {
    ...
    const hideEvent = _jquery.default.Event(Event.HIDE);
    ...
    this._isShown = false;
    const transition = (0, _jquery.default)(this._element).hasClass(ClassName.FADE);
    ...
    if (transition) {
      ...
      (0, _jquery.default)(this._element).one(_util.default.TRANSITION_END, event => this._hideModal(event)).emulateTransitionEnd(transitionDuration);
    } else {
      this._hideModal();
    }
  }
  ...
  dispose() {
    [window, this._element, this._dialog].forEach(htmlElement => (0, _jquery.default)(htmlElement).off(EVENT_KEY));
    /**
  ...
  _showElement(relatedTarget) {
    ...
    const shownEvent = _jquery.default.Event(Event.SHOWN, {
      relatedTarget
    });
    ...
    if (transition) {
      const transitionDuration = _util.default.getTransitionDurationFromElement(this._dialog);
  ...
  _enforceFocus() {
    ...
    .on(Event.FOCUSIN, event => {
      if (document !== event.target && this._element !== event.target && (0, _jquery.default)(this._element).has(event.target).length === 0) {
        this._element.focus();
      }
    });
  }
  ...
  _setEscapeEvent() {
    if (this._isShown && this._config.keyboard) {
      (0, _jquery.default)(this._element).on(Event.KEYDOWN_DISMISS, event => {
  ...
  _setResizeEvent() {
    if (this._isShown) {
      (0, _jquery.default)(window).on(Event.RESIZE, event => this.handleUpdate(event));
    } else {
  ...
  _hideModal() {
    ...
    this._showBackdrop(() => {
      ...
      (0, _jquery.default)(this._element).trigger(Event.HIDDEN);
    });
  }
  ...
  _showBackdrop(callback) {
    const animate = (0, _jquery.default)(this._element).hasClass(ClassName.FADE) ? ClassName.FADE : '';
    ...
    if (this._isShown && this._config.backdrop) {
      ...
      (0, _jquery.default)(this._element).on(Event.CLICK_DISMISS, event => {
      ...
      const backdropTransitionDuration = _util.default.getTransitionDurationFromElement(this._backdrop);
      ...
      if ((0, _jquery.default)(this._element).hasClass(ClassName.FADE)) {
        ...
        (0, _jquery.default)(this._backdrop).one(_util.default.TRANSITION_END, callbackRemove).emulateTransitionEnd(backdropTransitionDuration);
      } else {
        callbackRemove();
      }
    } else if (callback) {
  ...
  _setScrollbar() {
    if (this._isBodyOverflowing) {
      ...
      (0, _jquery.default)(fixedContent).each((index, element) => {
        ...
        const calculatedPadding = (0, _jquery.default)(element).css('padding-right');
        (0, _jquery.default)(element).data('padding-right', actualPadding).css('padding-right', `${parseFloat(calculatedPadding) + this._scrollbarWidth}px`);
      }); // Adjust sticky content margin

      (0, _jquery.default)(stickyContent).each((index, element) => {
        const actualMargin = element.style.marginRight;
        const calculatedMargin = (0, _jquery.default)(element).css('margin-right');
        (0, _jquery.default)(element).data('margin-right', actualMargin).css('margin-right', `${parseFloat(calculatedMargin) - this._scrollbarWidth}px`);
      }); // Adjust body padding

      const actualPadding = document.body.style.paddingRight;
      const calculatedPadding = (0, _jquery.default)(document.body).css('padding-right');
      (0, _jquery.default)(document.body).data('padding-right', actualPadding).css('padding-right', `${parseFloat(calculatedPadding) + this._scrollbarWidth}px`);
    }
  ...
  static _jQueryInterface(config, relatedTarget) {
    return this.each(function () {
      ...
      const _config = _objectSpread(_objectSpread(_objectSpread({}, Default), (0, _jquery.default)(this).data()), typeof config === 'object' && config ? config : {});
...
(0, _jquery.default)(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
  ...
  const config = (0, _jquery.default)(target).data(DATA_KEY) ? 'toggle' : _objectSpread(_objectSpread({}, (0, _jquery.default)(target).data()), (0, _jquery.default)(this).data());

  if (this.tagName === 'A' || this.tagName === 'AREA') {
    event.preventDefault();
  }

  const $target = (0, _jquery.default)(target).one(Event.SHOW, showEvent => {
...
class ScrollSpy {
  constructor(element, config) {
    ...
    (0, _jquery.default)(this._scrollElement).on(Event.SCROLL, event => this._process(event));
    this.refresh();
...
class Tab {
  ...
  show() {
    ...
    let target;
    let previous;
    const listElement = (0, _jquery.default)(this._element).closest(Selector.NAV_LIST_GROUP)[0];
    ...
    const complete = () => {
      const hiddenEvent = _jquery.default.Event(Event.HIDDEN, {
        relatedTarget: this._element
      });
  ...
  _activate(element, container, callback) {
    const activeElements = container && (container.nodeName === 'UL' || container.nodeName === 'OL') ? (0, _jquery.default)(container).find(Selector.ACTIVE_UL) : (0, _jquery.default)(container).children(Selector.ACTIVE);
    const active = activeElements[0];
    const isTransitioning = callback && active && (0, _jquery.default)(active).hasClass(ClassName.FADE);
  ...
  _transitionComplete(element, active, callback) {
    if (active) {
      ...
      const dropdownChild = (0, _jquery.default)(active.parentNode).find(Selector.DROPDOWN_ACTIVE_CHILD)[0];
    ...
    if (element.parentNode && (0, _jquery.default)(element.parentNode).hasClass(ClassName.DROPDOWN_MENU)) {
      const dropdownElement = (0, _jquery.default)(element).closest(Selector.DROPDOWN)[0];
