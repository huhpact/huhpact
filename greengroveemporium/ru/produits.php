...
<body>
    ...
    <div class="container">
        <h1 class="admin">Admin Panel - Продукты</h1>
        <div class="content">
    ...
    <div class="content">
        <h2>Редактировать продукты</h2>
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Введите идентификатор продукта">
            <button type="submit" name="fetch_product">Изменить продукт</button>
        </form>
        ...
        if(isset($_POST['fetch_product'])) {
            ...
            <form method="post">
                ...
                <label for="origin">Источник:</label>
                <input type="text" id="origin" name="origin" value="<?php echo $row['Herkunft']; ?>"><br>
                <button type="submit" name="update_product">Обновленный продукт</button>
            </form>
        <?php } ?>
        ...
        if(isset($_POST['update_product'])) {
            ...
            echo "<p class='act'>Данные о товаре обновлены!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Введите идентификатор продукта">
            <button type="submit" name="delete_product" class="btn-del">Введите идентификатор продукта</button>
        </form>
        ...
        if(isset($_POST['delete_product'])) {
            ...
            echo "<p class='act'>Товар удален!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_productname" name="new_productname" placeholder="наименование товара"><br>
            <input type="text" id="new_price" name="new_price" placeholder="Цена"><br>
            <input type="text" id="new_availability" name="new_availability" placeholder="Доступность"><br>
            <input type="text" id="new_origin" name="new_origin" placeholder="Источник"><br>
        ...
        if(isset($_POST['add_product'])) {
            ...
            echo "<p class='act'>Добавлен новый продукт</p>";
        }
        ?>
    </div>
    </div>
