...
<body>
    ...
    <div class="content">
        <h2>Edit Products</h2>
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Enter ProductID">
            <button type="submit" name="fetch_product">Edit Product</button>
        </form>
        ...
        if(isset($_POST['fetch_product'])) {
            ...
            <form method="post">
                ...
                <button type="submit" name="update_product">Product updated</button>
            </form>
        <?php } ?>
        ...
        if(isset($_POST['update_product'])) {
            ...
            echo "<p class='act'>Productdata updated!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Enter ProductID">
            <button type="submit" name="delete_product" class="btn-del">Delete Product</button>
        </form>
        ...
        if(isset($_POST['delete_product'])) {
            ...
            echo "<p class='act'>Product deleted!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_productname" name="new_productname" placeholder="Productname"><br>
            <input type="text" id="new_price" name="new_price" placeholder="Price"><br>
            <input type="text" id="new_availability" name="new_availability" placeholder="Availability"><br>
            <input type="text" id="new_origin" name="new_origin" placeholder="Origin"><br>
        ...
        if(isset($_POST['add_product'])) {
            ...
            echo "<p class='act'>New Product added!</p>";
        }
        ?>
    </div>
    </div>
