...
<body>
    ...
    <div class="container">
        <h1 class="admin">Admin Panel - Orders</h1>
        <div class="content">
        <h2>Orderdata</h2>
        <table>
            <tr>
    ...
    <div class="content">
        <h2>Edit Order</h2>
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Enter OrderID">
            <button type="submit" name="fetch_order">Edit Order</button>
        </form>
        ...
        if(isset($_POST['update_order'])) {
            ...
            echo "<p class='act'>Orderdata updated!</p>";
        }
        ?>
    </div>
    <div class="content">
        <h2>Delete Order</h2>
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Enter OrderID">
            <button type="submit" name="delete_order" class="btn-danger">Delete Order</button>
        </form>
        ...
        if(isset($_POST['delete_order'])) {
            ...
            echo "<p class='act'>Order deleted!</p>";
        }
        ?>
    </div>
    <div class="content">
        <h2>Add new Order</h2>
        <form method="post">
            <input type="text" id="new_customer_id" name="new_customer_id" placeholder="ClientID"><br>
            <input type="text" id="new_product_ids" name="new_product_ids" placeholder="ProductIDs"><br>
            <input type="text" id="new_total_quantity" name="new_total_quantity" placeholder="Quantity Products"><br>
            <input type="text" id="new_total_amount" name="new_total_amount" placeholder="Total Price"><br>
        ...
        if(isset($_POST['add_order'])) {
            ...
            echo "<p class='act'>New Order added!</p>";
        }
        ?>
    </div>
    </div>
