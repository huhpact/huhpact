...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
                <button class="page_act" type="submit" name="refresh_page">Refresh</button>
            </form>
    </div>
    <div class="content">
        <h2>Edit Client</h2>
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Enter ClientID">
            <button type="submit" name="fetch_customer">Edit Client</button>
        </form>
        ...
        if(isset($_POST['fetch_customer'])) {
            ...
            <form method="post">
                ...
                <button type="submit" name="update_customer">update Client</button>
            </form>
        <?php } ?>
        ...
        if(isset($_POST['update_customer'])) {
            ...
            echo "<p class='act'>Clientdata updated!</p>";
        }
        ?>
    </div>
    <div class="content">
        <h2>Delete Client</h2>
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Enter ClientID">
            <button type="submit" name="delete_customer" class="btn-del">Delete Client</button>
        </form>
        ...
        if(isset($_POST['delete_customer'])) {
            ...
            echo "<p class='act'>Client deleted!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_firstname" name="new_firstname" placeholder="First Name"><br>
            <input type="text" id="new_lastname" name="new_lastname" placeholder="Last Name"><br>
            
            <input type="text" id="new_email" name="new_email" placeholder="E-Mail"><br>
            
            <input type="text" id="new_phone" name="new_phone" placeholder="Phone Number"><br>
            
            <input type="text" id="new_street" name="new_street" placeholder="Street"><br>
            
            <input type="text" id="new_housenumber" name="new_housenumber" placeholder="House number"><br>
            
            <input type="text" id="new_zipcode" name="new_zipcode" placeholder="Postal Code"><br>
            
            <input type="text" id="new_city" name="new_city" placeholder="Place of Residence"><br>
            
            <input type="text" id="new_country" name="new_country" placeholder="Country"><br>
            <button type="submit" name="add_customer">Add new Client</button>
        </form>
        ...
        if(isset($_POST['add_customer'])) {
            ...
            echo "<p class='act'>New client added!</p>";
        }
        ?>
    </div>
    </div>
