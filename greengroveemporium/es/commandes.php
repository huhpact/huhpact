...
<body>
    ...
    <div class="container">
        <h1 class="admin">Admin Panel - Pedidos</h1>
        <div class="content">
    ...
    <div class="content">
        <h2>Editar orden</h2>
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Ingrese el ID del pedido">
            <button type="submit" name="fetch_order">Editar orden</button>
        </form>
        ...
        if(isset($_POST['fetch_order'])) {
            ...
            <form method="post">
                ...
                <label for="product_ids">ID de producto:</label>
                <input type="text" id="product_ids" name="product_ids" value="<?php echo $row['ProduktIDs']; ?>"><br>
                <label for="total_quantity">Cantidad de productos:</label>
                ...
                <button type="submit" name="update_order">orden de actualización</button>
            </form>
        <?php } ?>
        ...
        if(isset($_POST['update_order'])) {
            ...
            echo "<p class='act'>¡Datos de pedido actualizados!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Ingrese el ID del pedido">
            <button type="submit" name="delete_order" class="btn-danger">Eliminar pedido</button>
        </form>
        ...
        if(isset($_POST['delete_order'])) {
            ...
            echo "<p class='act'>Orden eliminado!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_customer_id" name="new_customer_id" placeholder="Identificación del cliente"><br>
            <input type="text" id="new_product_ids" name="new_product_ids" placeholder="ID de producto"><br>
            <input type="text" id="new_total_quantity" name="new_total_quantity" placeholder="Cantidad de productos"><br>
            <input type="text" id="new_total_amount" name="new_total_amount" placeholder="Precio total"><br>
            <button type="submit" name="add_order">Agregar nuevo pedido</button>
        </form>
        ...
        if(isset($_POST['add_order'])) {
            ...
            echo "<p class='act'>¡Nuevo pedido agregado!</p>";
        }
        ?>
    </div>
    </div>
