...
<body>
    ...
    <div class="container">
        <h1 class="admin">Admin Panel - Productos</h1>
        <div class="content">
    ...
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Ingrese el ID del producto">
            <button type="submit" name="fetch_product">Editar producto</button>
        </form>
        ...
        if(isset($_POST['fetch_product'])) {
            ...
            <form method="post">
                ...
                <button type="submit" name="update_product">Producto actualizado</button>
            </form>
        <?php } ?>
        ...
        if(isset($_POST['update_product'])) {
            ...
            echo "<p class='act'>¡Datos del producto actualizados!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Ingrese el ID del producto">
            <button type="submit" name="delete_product" class="btn-del">Eliminar producto</button>
        </form>
        ...
        if(isset($_POST['delete_product'])) {
            ...
            echo "<p class='act'>¡Producto eliminado!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_productname" name="new_productname" placeholder="Nombre del producto"><br>
            <input type="text" id="new_price" name="new_price" placeholder="Precio"><br>
            <input type="text" id="new_availability" name="new_availability" placeholder="Disponibilidad"><br>
            <input type="text" id="new_origin" name="new_origin" placeholder="Origen"><br>
        ...
        if(isset($_POST['add_product'])) {
            ...
            echo "<p class='act'>¡Nuevo producto agregado!</p>";
        }
        ?>
    </div>
    </div>
