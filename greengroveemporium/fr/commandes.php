...
<head>
    ...
    <title>Admin Panel - Commandes</title>
...
<body>
    ...
    <div class="container">
        <h1 class="admin">Admin Panel - Commandes</h1>
        <div class="content">
        <h2>Données commandes</h2>
        <table>
            <tr>
                <th>ID commande</th>
                <th>ID client</th>
    ...
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="edit_id" name="edit_id" placeholder="Saisir ID commande">
            <button type="submit" name="fetch_order">Modifier Order</button>
        </form>
        ...
        if(isset($_POST['update_order'])) {
            ...
            echo "<p class='act'>Données commandes mises à jour!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="delete_id" name="delete_id" placeholder="Saisir ID commande">
            <button type="submit" name="delete_order" class="btn-danger">Supprimer commande</button>
        </form>
        ...
        if(isset($_POST['delete_order'])) {
            ...
            echo "<p class='act'>commande supprimée!</p>";
        }
        ?>
    </div>
    <div class="content">
        ...
        <form method="post">
            <input type="text" id="new_customer_id" name="new_customer_id" placeholder="ID client"><br>
            <input type="text" id="new_product_ids" name="new_product_ids" placeholder="IDs produits"><br>
            <input type="text" id="new_total_quantity" name="new_total_quantity" placeholder="Quantité produits"><br>
            <input type="text" id="new_total_amount" name="new_total_amount" placeholder="Prix"><br>
            <button type="submit" name="add_order">Ajouter nouvelle commande</button>
        </form>
        ...
        if(isset($_POST['add_order'])) {
            ...
            echo "<p class='act'>Nouvelle commande ajoutée!</p>";
        }
        ?>
    </div>
    </div>
